...
// note: Due to the overhead required for inter-thread communication,
// setting stop-signal immediately after calling recordAsync on a recorder
// that does not set it will also work (but this is undefined behavior and
